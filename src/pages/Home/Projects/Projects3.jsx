...
const Projects3 = () => {
    ...
    return (
        <div>
            <div className='md:flex gap-8 my-16 px-8' data-aos="fade-up" data-aos-duration="1500">
                ...
                <div>
                    ...
                    <li className='text-slate-400 font-montserrat'><span className='text-teal-400'>Front-end technology:</span>React js, Bootstrap, React Bootstrap, React Router, Firebase Authentication</li>
